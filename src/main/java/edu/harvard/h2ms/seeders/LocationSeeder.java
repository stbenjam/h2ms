...
public class LocationSeeder {
    ...
    private void seedLocationTable() {
        // Top level locations
        final Location massGeneral = saveNewLocation("Hospital",
                "Massachusetts General Hospital", "USA",
                "55 Fruit Street Boston, MA", "02114");

        final Location cambrideHealth = saveNewLocation("Hospital",
                "Cambridge Health Alliance", "USA",
                "1493 Cambridge St, Cambridge, MA", "02139");

        saveNewLocation("Clinic", "Massachusetts Health Clinic", "USA",
                "123 Anywhere St, Boston, MA", "02114");

        // Wards
        final Location massGeneralEmergencyRoom = addChildLocation("Ward",
                "Emergency Room", massGeneral);
    ...
    private Location saveNewLocation(final String type, final String name, final String country,
                                     final String address, final String zip) {
